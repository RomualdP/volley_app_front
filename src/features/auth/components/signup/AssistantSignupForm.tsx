...
import { signupAssistant, validateInvitationToken } from "../../api/signup.api";
import { useAuthStore } from "../../../../store/useAuthStore";
import { ROUTES } from "../../../../constants";
import type { SignupAssistantDto } from "../../types/signup.types";
...
export function AssistantSignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const signupData: SignupAssistantDto = {
      ...
      const response = await signupAssistant(signupData);

      // Check if assistant had previous club
